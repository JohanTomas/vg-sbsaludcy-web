                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            ...
                            <form class="form-horizontal" method="post" id="addproduct" action="/Contnewq" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="symtoms" required placeholder="Sintomas"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="form-control" name="message" id="message" rows="4" placeholder="Escribe el mensaje aquí..."></textarea>
                                    </div>
                                </div>
