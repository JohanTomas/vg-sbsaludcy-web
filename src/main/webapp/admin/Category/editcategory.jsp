                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            ...
                            <form class="form-horizontal" method="post" id="addproduct" action="/Contactucat" role="form">
                                <input type="hidden" name="category_id" value="${category.id}">
                                <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 control-label">Nombre*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="name" required class="form-control" id="name" placeholder="Nombre" oninput="this.value = this.value.toUpperCase()" value="${category.name}">
                                        <span id="name-error" class="error-message">La categoria solo debe contener letras</span>
                                    </div>
                                </div>

                                <input type="hidden" name="is_active" value="${category.isActive}" checked>

                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button type="submit" class="btn btn-primary">Editar Categoria</button>
                                        <a href="/Contcategory" class="btn btn-primary">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
