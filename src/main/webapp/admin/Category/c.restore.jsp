...
<head>
    ...
    <title>Restaurar Categorias | Sistema</title>
    <!-- CARPETA RESOURCE -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" data-background-color="blue">
                            <h4 class="title">Restaurar Categorias</h4>
                        </div>
                        <div class="card-content table-responsive">
                            ...
                            <table id="categoryrsTable" class="table table-bordered table-hover">
                                <thead>
                                ...
                                <c:forEach items="${categoryList}" var="category">
                                    <tr>
                                        ...
                                        <td style="width:120px; text-align: center; vertical-align: middle;">
                                            <a href="/Contrestorec?id=${category.id}" class="btn btn-danger btn-xs restore-btn">Restaurar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.restore-btn').on('click', function(e) {
                ...
                swal({
                    title: "¿Deseas restaurar a la Categoria?",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
            ...
            $('#searchInput').on('keyup', function() {
                ...
                $('#categoryrsTable tbody tr').filter(function() {
