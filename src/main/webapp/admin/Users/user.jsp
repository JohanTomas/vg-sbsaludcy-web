                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            ...
                            <a href="/Contu_restore" class="btn btn-primary">Restaurar Usuario</a>
                            ...
                            <table id="usersTable" class="table table-bordered table-hover">
                                <thead>
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Labor/Rol</th>
                                ...
                                <c:forEach items="${userList}" var="user">
                                    <tr>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">${user.is_admin}</td>
                                        <td style="width:180px; text-align: center; vertical-align: middle;">
                                            <a href="/Conteditu?id=${user.id}" class="btn btn-warning btn-xs">Editar</a>
                                            <a href="/Contdeleteu?id=${user.id}" class="btn btn-danger btn-xs delete-btn">Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
