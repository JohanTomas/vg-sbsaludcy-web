                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            ...
                            <form class="form-horizontal" method="post" id="addproduct" action="/Contnewu" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="password" name="password" required class="form-control" id="inputEmail1" placeholder="Contraseña">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select name="is_admin" class="form-control" required>
                                            ...
                                            <option value="TRABAJADOR">TRABAJOR</option>
                                        </select>
                                    </div>
                                </div>
