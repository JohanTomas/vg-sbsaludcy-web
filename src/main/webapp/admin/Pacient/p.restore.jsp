...
<head>
    ...
    <title>Restaurar Pacientes | Sistema</title>
    <!-- CARPETA RESOURCE -->
...
<body>
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <button type="button" class="navba  r-toggle" data-toggle="collapse">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="blue">
                            <h4 class="title">Restaurar Pacientes</h4>
                        </div>
                        <div class="card-content table-responsive">
                            ...
                            <table id="patientrsTable" class="table table-bordered table-hover">
                                <thead>
                                ...
                                <c:forEach items="${pacientList}" var="pacient">
                                    <tr>
                                        ...
                                        <td style="width:140px; text-align: center; vertical-align: middle;">
                                            <a href="/Contrestorep?id=${pacient.id}" class="btn btn-danger btn-xs restore-btn">Restaurar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.restore-btn').on('click', function(e) {
                ...
                swal({
                    title: "¿Deseas restaurar al Paciente?",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
            ...
            $('#searchInput').on('keyup', function() {
                ...
                $('#patientrsTable tbody tr').filter(function() {
    ...
    <script type="text/javascript">
        ...
        function exportToCSV() {
            const rows = document.querySelectorAll("#patientrsTable tbody tr");
            const csvData = [['Nombre completo', 'DNI', 'Fecha de Nacimiento', 'Dirección', 'Email', 'Teléfono']];
            rows.forEach(row => {
            ...
            link.setAttribute("download", "Pacientes Inactivo.csv");
        ...
        function exportToXLS() {
            ...
            const rows = document.querySelectorAll("#patientrsTable tbody tr");
            const data = [['Nombre completo', 'DNI', 'Fecha de Nacimiento', 'Dirección', 'Email', 'Teléfono']];
            rows.forEach(row => {
                const cols = row.querySelectorAll('td');
                const rowData = [];
                cols.forEach((col, index) => {
            ...
            XLSX.writeFile(wb, 'Pacientes Inactivo.xlsx');
        }
        ...
        async function exportTableToPDF() {
            ...
            doc.autoTable({
                head: [['Nombre completo', 'DNI', 'Fecha de Nacimiento', 'Dirección', 'Email', 'Teléfono']],
                body: tableData,
                startY: 10,
                headStyles: { fillColor: [22, 160, 133] },
                styles: { fontSize: 10, cellPadding: 2, halign: 'center' }
            });
            doc.save('Pacientes Inactivo.pdf');
        }
    </script>
