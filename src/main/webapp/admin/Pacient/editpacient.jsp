...
<body>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <form class="form-horizontal" method="post" id="addproduct" action="/Contactup" role="form">
                                <input type="hidden" name="pacient_id" value="${pacient.id}">

                                <div class="form-group">
                                    <label for="name" class="col-lg-2 control-label">Nombre*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="name" required class="form-control" id="name" placeholder="Nombre" oninput="this.value = this.value.toUpperCase()" value="${pacient.name}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="lastname" required class="form-control" id="lastname" placeholder="Apellido" oninput="this.value = this.value.toUpperCase()" value="${pacient.lastname}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label class="checkbox-inline">
                                            <input type="radio" id="inlineCheckbox1" name="gender" value="H" <c:if test="${pacient.gender == 'H'}">checked</c:if>> Hombre
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="radio" id="inlineCheckbox2" name="gender" value="M" <c:if test="${pacient.gender == 'M'}">checked</c:if>> Mujer
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <select id="document_type" name="document_type" class="form-control" required >
                                            ...
                                            <option value="DNI" <c:if test="${pacient.document_type == 'DNI'}">selected</c:if>>DNI</option>
                                            <option value="CNI" <c:if test="${pacient.document_type == 'CNI'}">selected</c:if>>CNI</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="document_dni" required class="form-control" id="document_dni" placeholder="Número de Documento" value="${pacient.document_dni}">
                                ...
                                <!--<div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="document_dni" class="form-control" required id="dni" placeholder="DNI" >
                                    </div>
                                </div>-->
                                <div class="form-group">
                                    <label for="day_of_birth" class="col-lg-2 control-label">Fecha de Nacimiento*</label>
                                    <div class="col-md-6">
                                        <input type="date" name="day_of_birth" class="form-control" required id="day_of_birth" placeholder="Fecha de Nacimiento" value="${pacient.day_of_birth}">
                                        <span id="fechan-error" class="error-message">Debes ser mayor de 18 años</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="address1" class="col-lg-2 control-label">Dirección*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="address" class="form-control" required id="address1" placeholder="Direccion" value="${pacient.address}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-lg-2 control-label">Email*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="email" class="form-control" required id="email" placeholder="Email" value="${pacient.email}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="phone" class="form-control" required id="phone1" placeholder="Telefono" value="${pacient.phone}">
                                        <span id="phone-error" class="error-message">El telefono debe ser valido</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="sickness" class="col-lg-2 control-label">Enfermedad Preexistente*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="sickness" class="form-control" required id="sickness" placeholder="Enfermedad" value="${pacient.sickness}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="alergy" class="col-lg-2 control-label">Alergia*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="alergy" required class="form-control" id="alergy" placeholder="Alergia" value="${pacient.alergy}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        ...
                                        <a href="/Contpacient" class="btn btn-primary">Cancelar</a>
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const FechaNField = document.getElementById('day_of_birth');
            ...
            const FechaNError = document.getElementById('fechan-error');
            ...
            function validateForm() {
                ...
                validateDOB(FechaNField, FechaNError);
            ...
            FechaNField.addEventListener('input', () => validateDOB(FechaNField, FechaNError));
        });
    </script>
