                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            ...
                            <form class="form-horizontal" method="post" id="addproduct" action="/Contnewp" role="form" onsubmit="return validateForm()">
                                ...
                                <!--<div class="form-group">
                                    <label for="document_dni" class="col-lg-2 control-label">DNI*</label>
                                    <div class="col-md-6">
                                        <input type="text" name="document_dni" required class="form-control" id="document_dni" placeholder="DNI">
                                    </div>
                                </div>-->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" required name="address" class="form-control" id="address1" placeholder="Dirección">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" required name="phone" class="form-control" id="phone1" placeholder="Telefono">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="sickness" required class="form-control" id="sickness" placeholder="Enfermedad"></textarea>
                                        <span class="day"> Si no cuenta con alguna enfermedad preexistente ponga "NINGUNO"</span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="alergy" class="col-lg-2 control-label">Alergia*</label>
                                    <div class="col-md-6">
                                        <textarea name="alergy" required class="form-control" id="alergy" placeholder="Alergia"></textarea>
                                        <span class="day"> Si no cuenta con alguna alergia ponga "NINGUNO"</span>
                                    </div>
                                </div>
