            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
                        <form class="form-horizontal" method="post" id="addproduct" action="/Contactum" role="form">
                                ...
                                <div class="col-md-6">
                                    <select name="category_id" class="form-control" required>
                                        ...
                                        <c:forEach items="${categoryList}" var="category">
                                            <option value="${category.id}" <c:if test="${category.id == medic.category_id}">selected</c:if>>${category.name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="name" required class="form-control" id="name" placeholder="Nombre" oninput="this.value = this.value.toUpperCase()" value="${medic.name}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="lastname" required class="form-control" id="lastname" placeholder="Apellido" oninput="this.value = this.value.toUpperCase()" value="${medic.lastname}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="checkbox-inline">
                                        <input type="radio" id="inlineCheckbox1" name="gender" value="H" <c:if test="${medic.gender == 'H'}">checked</c:if>> Hombre
                                    </label>
                                    <label class="checkbox-inline">
                                        <input type="radio" id="inlineCheckbox2" name="gender" value="M" <c:if test="${medic.gender == 'M'}">checked</c:if>> Mujer
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="document_type" name="document_type" class="form-control" required>
                                        <option value="">-- SELECCIONAR --</option>
                                        <option value="DNI" <c:if test="${medic.document_type == 'DNI'}">selected</c:if>>DNI</option>
                                        <option value="CNI" <c:if test="${medic.document_type == 'CNI'}">selected</c:if>>CNI</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="document_dni" required class="form-control" id="document_dni" placeholder="Número de Documento" value="${medic.document_dni}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="day_of_birth" required class="form-control" id="day_of_birth" placeholder="Fecha de Nacimiento" value="${medic.day_of_birth}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="address" required class="form-control" id="address1" placeholder="Direccion" value="${medic.address}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="email" class="col-lg-2 control-label">Email*</label>
                                <div class="col-md-6">
                                    <input type="text" name="email" required class="form-control" id="email" placeholder="Email" value="${medic.email}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="phone" required class="form-control" id="phone1" placeholder="Telefono" value="${medic.phone}">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateForm() {
            ...
            return invalidFields.length === 0 && isDocumentValid; // Only submit if there are no invalid fields
        }
