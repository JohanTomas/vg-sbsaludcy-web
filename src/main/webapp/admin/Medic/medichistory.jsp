...
<head>
    ...
    <title>Historial de Citas del Medico</title>
    <!-- CARPETA RESOURCE -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header" data-background-color="blue">
                            ...
                            <p>Medico: ${medic.name} ${medic.lastname}</p>
                        </div>
                        <br><br>
                        <div class="card-content table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;">${medic.name}</td>
                                    <td style="text-align: center; vertical-align: middle;">${medic.lastname}</td>
                                    <td style="text-align: center; vertical-align: middle;">${medic.gender}</td>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; vertical-align: middle;">${medic.email}</td>
