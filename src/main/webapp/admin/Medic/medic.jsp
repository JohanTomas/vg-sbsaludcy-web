...
<body>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content table-responsive">
                            <a href="/Contnewmc" class="btn btn-primary"><i class='fa fa-support'></i> Nuevo Medico</a>
                            <a href="/Contm_restore" class="btn btn-primary">Restaurar Medico</a>
                            ...
                            <table id="medicsTable" class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${medicList}" var="medic">
                                    <tr>
                                        ...
                                        <td style="text-align: center; vertical-align: middle;">${medic.name} ${medic.lastname}</td>
                                        ...
                                        <td style="width:280px; text-align: center; vertical-align: middle;">
                                            <a href="/Contm_history?id=${medic.id}" class="btn btn-primary btn-xs">Historial</a>
                                            <a href="/Conteditm?id=${medic.id}" class="btn btn-warning btn-xs">Editar</a>
                                            <a href="/Contdeletem?id=${medic.id}" class="btn btn-danger btn-xs delete-btn">Eliminar</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#searchInput').on('keyup', function() {
                ...
                $('#medicsTable tbody tr').filter(function() {
    ...
    <script type="text/javascript">
        ...
        function exportToCSV() {
            const rows = document.querySelectorAll("#medicsTable tbody tr");
            ...
            link.setAttribute("download", "Medicos.csv");
