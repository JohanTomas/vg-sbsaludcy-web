...
<head>
    ...
    <title>Recetas Medicas | Sistema</title>
    <!-- CARPETA RESOURCE -->
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header" data-background-color="blue">
                        <h4 class="title">Recetas</h4>
                    </div>
                    <div class="card-content table-responsive">
                        <a href="/Contnewpres" class="btn btn-primary"><i class="fa fa-support"></i> Nueva Receta</a>
                        <a href="/pr_restore" class="btn btn-primary">Recetas Anteriores</a>
                        <br><br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="created_at" value="Palabra clave" class="form-control" placeholder="Palabra clave">
                                    </div>
                                </div>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <th style="text-align: center; vertical-align: middle;">Nombre cita</th>
                            <th style="text-align: center; vertical-align: middle;">Paciente</th>
                            <th style="text-align: center; vertical-align: middle;">Medico</th>
                            <th style="text-align: center; vertical-align: middle;">Enfermedad</th>
                            <th style="text-align: center; vertical-align: middle;">Medicamentos</th>
                            <th style="text-align: center; vertical-align: middle;">Precio</th>
                            <th style="text-align: center; vertical-align: middle;">Fecha creacion</th>
                            <th style="text-align: center; vertical-align: middle;">Acciones</th>
                            </thead>
                            <c:forEach items="${prescriptionList}" var="prescription">
                                <tr>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.id}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.title}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.pacient_name} ${prescription.pacient_lastname}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.medic_name} ${prescription.medic_lastname}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.sickness}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.medicaments}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.price}</td>
                                    <td style="text-align: center; vertical-align: middle;">${prescription.created_at}</td>
                                    <td style="width:180px; text-align: center; vertical-align: middle;">
                                        <a href="/Conteditpr?id=${prescription.id}" class="btn btn-warning btn-xs">Editar</a>
                                        <a href="/Contdeletepr?id=${prescription.id}" class="btn btn-danger btn-xs delete-btn">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
