            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="blue">
                        <h4 class="title">Modificar Receta</h4>
                    </div>
                    <div class="card-content table-responsive">
                        <form class="form-horizontal" role="form" method="post" action="/Contupdatepr">
                            <input type="hidden" name="prescription_id" value="${presription.id}">
                                ...
                                <div class="col-md-6">
                                    <select name="reservation_id" class="form-control" required>
                                        ...
                                        <c:forEach items="${quotesList}" var="quotes">
                                            <option value="${quotes.id}">${quotes.title}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
